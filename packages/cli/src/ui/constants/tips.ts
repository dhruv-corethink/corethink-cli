...
export const INFORMATIVE_TIPS = [
  ...
  'Toggle respect for .corethinkignore files in context (/settings)...',
  ...
  'Show CoreThink CLI status in the terminal window title (/settings)...',
  ...
  'Submit your prompt to CoreThink with Enter...',
  ...
  'Create a project-specific CORETHINK.md file with /init...',
  ...
  'Reload instructional context from CORETHINK.md files with /memory refresh...',
  'List the paths of the CORETHINK.md files in use with /memory list...',
