...
import { ExitCodes } from 'corethink-cli-core';
      ...
      >
        <Box flexDirection="column" marginBottom={1}>
          ...
          <Text color={theme.text.primary}>
            Trusting a folder allows CoreThink to execute commands it suggests.
      ...
      {isRestarting && (
        <Box marginLeft={1} marginTop={1}>
          <Text color={theme.status.warning}>
            CoreThink CLI is restarting to apply the trust changes...
          </Text>
        </Box>
      )}
      {exiting && (
