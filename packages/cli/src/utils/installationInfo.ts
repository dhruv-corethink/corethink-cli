...
import { debugLogger, isGitRepository } from 'corethink-cli-core';
...
export function getInstallationInfo(
  ...
  try {
    ...
    if (realPath.includes('/.pnpm/global')) {
      const updateCommand = 'pnpm add -g corethink-cli@latest';
      return {
    ...
    if (realPath.includes('/.yarn/global')) {
      const updateCommand = 'yarn global add corethink-cli@latest';
      return {
    ...
    if (realPath.includes('/.bun/bin')) {
      const updateCommand = 'bun add -g corethink-cli@latest';
      return {
    ...
    // Assume global npm
    const updateCommand = 'npm install -g corethink-cli@latest';
    return {
