  ...
  ui: {
    ...
    properties: {
      ...
      showStatusInTitle: {
        ...
        default: false,
        description:
          'Show CoreThink CLI status and thoughts in the terminal window title',
        showInDialog: true,
      },
      hideTips: {
        type: 'boolean',
      ...
      hideContextSummary: {
        ...
        default: false,
        description:
          'Hide the context summary (CORETHINK.md, MCP servers) above the input.',
        showInDialog: true,
      },
      footer: {
        type: 'object',
  ...
  context: {
    ...
    properties: {
      ...
      loadMemoryFromIncludeDirectories: {
        ...
        default: false,
        description: oneLine`
          Controls how /memory refresh loads CORETHINK.md files.
      ...
      fileFiltering: {
        ...
        properties: {
          ...
          respectGeminiIgnore: {
            type: 'boolean',
            label: 'Respect .corethinkignore',
            category: 'Context',
            requiresRestart: true,
            default: true,
            description: 'Respect .corethinkignore (and legacy .geminiignore) files when searching',
            showInDialog: true,
          },
